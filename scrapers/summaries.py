...
BRIEF = (
    ...
    "- describes what happens in the film, at the level of premise, not plot summary\n"
    "- is at most 58 characters including spaces, and splits at a word boundary "
    f"into two lines of at most {LINE} characters each\n"
    "- is present tense and opens on an indefinite article where it reads naturally "
    "(\"A poet crosses into the realm of death in pursuit of love.\")\n"
    "- never repeats the film's title, never evaluates it, never mentions "
    "restorations, prints, formats, anniversaries or the venue\n"
    "- stays with what the supplied notes support; invent nothing\n\n"
